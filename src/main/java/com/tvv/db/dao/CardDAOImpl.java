...
public class CardDAOImpl implements CardDAO{
    ...
    public void setUp(DBManager dbm, UserDAOImpl userDAO) {
        this.dbManager = dbm;
     ...
     */
    @Override
    public List<Card> getCards(Long userId, String sqlRequest) throws AppException {
        List<Card> cards = new ArrayList<>();
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        Connection con = null;
    ...
    private static class CardLoad implements LoadEntity<Card> {
        ...
        public CardLoad(UserDAOImpl userDAO) {
            this.userDAO = userDAO;
        }
