...
class LoadListPaymentsCommandTest {
    ...
    void testExecuteGetUser() throws ServletException, IOException {
        ...
        when(request.getRequestDispatcher("/list.payments.jsp")).thenReturn(disp);

        new LoadListPaymentsCommand().executeGet(request,response);
        verify(request).getRequestDispatcher("/list.payments.jsp");
